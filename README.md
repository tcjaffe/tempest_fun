...
3. Follow the steps at https://apidocs.tempestwx.com/reference/quick-start to generate a Personal Data Token.  Note that OAuth is recommended for larger scale commercial use cases.  This is just a toy project for interacting with my own Tempest so I use the Personal Data Token route.
...
5. `direnv allow .`
6. `source tempest_fun/bin/activate`
7. Run the code!: `python tempest_api_client.py`
